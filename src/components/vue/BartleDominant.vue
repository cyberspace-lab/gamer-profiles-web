    ...
    <section class="relative not-prose scroll-mt-[72px]">
        <div class="relative px-4 md:px-6 py-12 md:py-16 lg:py-20 text-default max-w-7xl mx-auto pt-0 md:pt-0 lg:pt-0">
            <div class="mx-auto max-w-7xl p-4 md:px-8">
                <h1 class="text-3xl font-bold leading-tighter tracking-tighter font-heading text-heading text-center mb-8 md:mb-12">Dominantní typ</h1>
                <div class="md:flex md:gap-16">
                    <div class="self-center">
                        <div class="mb-12 text-lg dark:text-slate-400">
                            <h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">{{personality.dominantType}}</h3>
                            <p class="text-muted">
                        ...
                        <div class="grid mx-auto gap-8 gap-y-4 md:gap-y-8">
                            <div>
                                <div class="flex flex-row max-w-none">
                                    ...
                                    <div class="mt-0.5">
                                        <h3 class="text-lg font-medium leading-6 dark:text-white ml-2 rtl:ml-0 rtl:mr-2">{{ personality.subtype }}</h3>
